...
-- ----------------------------
INSERT INTO `class_article` VALUES (1, 'Spring Boot 入门教程', '本文介绍Spring Boot的基本使用和配置', '<h1><img src=\"/dev-api/profile/upload/2025/11/02/屏幕截图 2024-06-06 011230_20251102021029A001.png\">入门</h1>', 'https://picsum.photos/id/1029/600/400', '技术', 'published', 168, 12, 60, 13, 0, '岂皓月', 1, 'admin', '2025-11-01 23:24:22', '', '2025-11-08 00:31:20', NULL);
INSERT INTO `class_article` VALUES (2, '生活中的小确幸', '记录生活中的美好瞬间，( •̀ ω •́ )y', '<p>生活中总有一些小确幸让我们感到温暖...美好！</p>', 'https://picsum.photos/id/1035/600/400', '生活', 'published', 91, 8, 34, 1, 0, '岂皓月', 1, 'admin', '2025-11-01 23:24:22', '', '2025-11-04 22:58:40', NULL);
...
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '签到二维码/token 表（用于动态二维码与失效控制）' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `class_attendance_qr` VALUES (2, 8, 'eee658542ae04a52ad424d2ef5302ec7', 600, '2025-11-08 00:41:00', 0, 'admin', '2025-11-08 00:31:00');
...
) ENGINE = InnoDB AUTO_INCREMENT = 9 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '签到任务表（记录签到活动：位置/二维码等）' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `class_attendance_task` VALUES (7, 1, 'location', 12, 12, 500, NULL, '2025-11-09 00:00:00', '2025-11-10 00:00:00', 1, 'admin', '2025-11-08 00:30:44');
INSERT INTO `class_attendance_task` VALUES (8, 1, 'qr', 12, 12, 500, NULL, '2025-11-09 00:00:00', '2025-11-10 00:00:00', 1, 'admin', '2025-11-08 00:30:59');
...
) ENGINE = InnoDB AUTO_INCREMENT = 22 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '作业主表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `class_homework` VALUES (19, 1, 1, '111', '111', NULL, 100.00, '2025-11-09 00:00:00', '', NULL, '0', 'admin', '2025-11-08 01:43:10', '', NULL, NULL, NULL, NULL);
...
INSERT INTO `class_random_pick` VALUES (19, 1, 0, 32, '2025-11-08 00:30:24', NULL, NULL);
...
) ENGINE = InnoDB AUTO_INCREMENT = 16 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '学生作业表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `class_student_homework` VALUES (14, 19, 38, NULL, NULL, NULL, NULL, NULL, '2025-11-08 01:55:24', 1, 90.00, '', '2', 'admin', '2025-11-08 01:53:47', 'admin', '2025-11-08 01:55:24', NULL, NULL, NULL, NULL, NULL, NULL);
...
INSERT INTO `sys_logininfor` VALUES (119, 'admin', '127.0.0.1', '内网IP', 'Chrome 14', 'Windows 10', '0', '登录成功', '2025-11-07 09:39:27');
INSERT INTO `sys_logininfor` VALUES (120, 'admin', '127.0.0.1', '内网IP', 'Chrome 14', 'Windows 10', '0', '登录成功', '2025-11-07 22:12:08');
INSERT INTO `sys_logininfor` VALUES (121, 'admin', '127.0.0.1', '内网IP', 'Chrome 14', 'Windows 10', '0', '登录成功', '2025-11-09 01:22:34');
INSERT INTO `sys_logininfor` VALUES (122, 'admin', '127.0.0.1', '内网IP', 'Chrome 14', 'Windows 10', '0', '登录成功', '2025-11-09 12:40:52');
INSERT INTO `sys_logininfor` VALUES (123, 'admin', '127.0.0.1', '内网IP', 'Chrome 14', 'Windows 10', '0', '登录成功', '2025-11-09 16:23:52');
INSERT INTO `sys_logininfor` VALUES (124, 'admin', '127.0.0.1', '内网IP', 'Chrome 14', 'Windows 10', '0', '登录成功', '2025-11-09 17:58:04');
INSERT INTO `sys_logininfor` VALUES (125, 'admin', '127.0.0.1', '内网IP', 'Chrome 14', 'Windows 10', '0', '登录成功', '2025-11-09 18:05:24');
INSERT INTO `sys_logininfor` VALUES (126, 'admin', '127.0.0.1', '内网IP', 'Chrome 14', 'Windows 10', '0', '登录成功', '2025-11-09 18:58:53');
...
INSERT INTO `sys_menu` VALUES (2000, '作业管理', 0, 0, 'proj_lwj', NULL, NULL, '', 1, 0, 'M', '0', '0', '', 'education', 'admin', '2025-11-02 15:16:04', 'admin', '2025-11-07 22:32:40', '');
INSERT INTO `sys_menu` VALUES (2002, '作业发布', 2000, 1, 'homework_publish', '', NULL, '', 1, 0, 'C', '0', '0', '', 'list', 'admin', '2025-11-02 15:17:17', 'admin', '2025-11-09 01:26:59', '');
INSERT INTO `sys_menu` VALUES (2003, '作业上传', 2000, 2, 'homework_upload', '', NULL, '', 1, 0, 'C', '0', '0', '', 'upload', 'admin', '2025-11-02 15:18:15', 'admin', '2025-11-07 23:34:16', '');
...
INSERT INTO `sys_menu` VALUES (2020, '作业批改', 2000, 3, 'homework_grading', '', NULL, '', 1, 0, 'C', '0', '0', '', 'edit', 'admin', '2025-11-07 10:07:32', 'admin', '2025-11-07 23:34:10', '');
INSERT INTO `sys_menu` VALUES (2023, '提交列表', 2000, 3, 'homework_grading/list/:homeworkId', NULL, NULL, '', 1, 0, 'C', '1', '0', '', 'list', 'admin', '2025-11-07 23:23:43', 'admin', '2025-11-07 23:34:03', '');
...
INSERT INTO `sys_oper_log` VALUES (227, '菜单管理', 1, 'com.ruoyi.web.controller.system.SysMenuController.add()', 'POST', 1, 'admin', '研发部门', '/system/menu', '127.0.0.1', '内网IP', '{\"children\":[],\"createBy\":\"admin\",\"icon\":\"checkbox\",\"isCache\":\"0\",\"isFrame\":\"1\",\"menuName\":\"作业批改\",\"menuType\":\"C\",\"orderNum\":0,\"params\":{},\"parentId\":2000,\"path\":\"homework_grading\",\"status\":\"0\",\"visible\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-11-07 10:07:32', 269);
INSERT INTO `sys_oper_log` VALUES (228, '作业提交', 1, 'com.ruoyi.web.controller.proj_lwj.ClassHomeworkController.submit()', 'POST', 1, 'admin', '研发部门', '/proj_lwj/homework/submit', '127.0.0.1', '内网IP', '{\"createBy\":\"admin\",\"homeworkId\":10,\"params\":{},\"remark\":\"\",\"status\":1,\"studentHomeworkId\":9,\"studentId\":38,\"studentName\":\"黎文靖\",\"studentNo\":\"2023141460368\",\"submissionFiles\":\"测试作业.docx\",\"submitTime\":\"2025-11-07 10:27:26\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-11-07 10:27:27', 278);
INSERT INTO `sys_oper_log` VALUES (229, '菜单管理', 1, 'com.ruoyi.web.controller.system.SysMenuController.add()', 'POST', 1, 'admin', '研发部门', '/system/menu', '127.0.0.1', '内网IP', '{\"children\":[],\"createBy\":\"admin\",\"icon\":\"checkbox\",\"isCache\":\"0\",\"isFrame\":\"1\",\"menuName\":\"作业批改详情\",\"menuType\":\"C\",\"orderNum\":0,\"params\":{},\"parentId\":2020,\"path\":\"homeworkId\",\"status\":\"0\",\"visible\":\"1\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-11-07 10:34:17', 42);
INSERT INTO `sys_oper_log` VALUES (230, '菜单管理', 2, 'com.ruoyi.web.controller.system.SysMenuController.edit()', 'PUT', 1, 'admin', '研发部门', '/system/menu', '127.0.0.1', '内网IP', '{\"children\":[],\"createTime\":\"2025-11-07 10:34:17\",\"icon\":\"checkbox\",\"isCache\":\"0\",\"isFrame\":\"1\",\"menuId\":2021,\"menuName\":\"作业批改详情\",\"menuType\":\"C\",\"orderNum\":0,\"params\":{},\"parentId\":2020,\"path\":\"homework_grading/:homeworkId\",\"perms\":\"\",\"routeName\":\"\",\"status\":\"0\",\"updateBy\":\"admin\",\"visible\":\"1\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-11-07 10:35:03', 35);
INSERT INTO `sys_oper_log` VALUES (231, '菜单管理', 2, 'com.ruoyi.web.controller.system.SysMenuController.edit()', 'PUT', 1, 'admin', '研发部门', '/system/menu', '127.0.0.1', '内网IP', '{\"children\":[],\"createTime\":\"2025-11-07 10:34:17\",\"icon\":\"checkbox\",\"isCache\":\"0\",\"isFrame\":\"1\",\"menuId\":2021,\"menuName\":\"作业批改详情\",\"menuType\":\"C\",\"orderNum\":0,\"params\":{},\"parentId\":2020,\"path\":\"homework_grading/:homeworkId\",\"perms\":\"\",\"routeName\":\"\",\"status\":\"0\",\"updateBy\":\"admin\",\"visible\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-11-07 10:35:51', 27);
INSERT INTO `sys_oper_log` VALUES (232, '菜单管理', 2, 'com.ruoyi.web.controller.system.SysMenuController.edit()', 'PUT', 1, 'admin', '研发部门', '/system/menu', '127.0.0.1', '内网IP', '{\"children\":[],\"createTime\":\"2025-11-07 10:34:17\",\"icon\":\"checkbox\",\"isCache\":\"0\",\"isFrame\":\"1\",\"menuId\":2021,\"menuName\":\"作业批改详情\",\"menuType\":\"C\",\"orderNum\":0,\"params\":{},\"parentId\":2020,\"path\":\"homeworkId\",\"perms\":\"\",\"routeName\":\"\",\"status\":\"0\",\"updateBy\":\"admin\",\"visible\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-11-07 10:38:44', 27);
INSERT INTO `sys_oper_log` VALUES (233, '作业提交', 1, 'com.ruoyi.web.controller.proj_lwj.ClassHomeworkController.submit()', 'POST', 1, 'admin', '研发部门', '/proj_lwj/homework/submit', '127.0.0.1', '内网IP', '{\"createBy\":\"admin\",\"homeworkId\":11,\"params\":{},\"remark\":\"\",\"status\":1,\"studentHomeworkId\":10,\"studentId\":38,\"studentName\":\"黎文靖\",\"studentNo\":\"2023141460368\",\"submissionFiles\":\"测试作业.docx\",\"submitTime\":\"2025-11-07 11:12:32\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-11-07 11:12:32', 302);
INSERT INTO `sys_oper_log` VALUES (234, '菜单管理', 2, 'com.ruoyi.web.controller.system.SysMenuController.edit()', 'PUT', 1, 'admin', '研发部门', '/system/menu', '127.0.0.1', '内网IP', '{\"children\":[],\"createTime\":\"2025-11-07 10:34:17\",\"icon\":\"checkbox\",\"isCache\":\"0\",\"isFrame\":\"1\",\"menuId\":2021,\"menuName\":\"作业批改详情\",\"menuType\":\"C\",\"orderNum\":0,\"params\":{},\"parentId\":2020,\"path\":\"homeworkId\",\"perms\":\"\",\"routeName\":\"\",\"status\":\"0\",\"updateBy\":\"admin\",\"visible\":\"1\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-11-07 11:24:42', 65);
INSERT INTO `sys_oper_log` VALUES (235, '菜单管理', 1, 'com.ruoyi.web.controller.system.SysMenuController.add()', 'POST', 1, 'admin', '研发部门', '/system/menu', '127.0.0.1', '内网IP', '{\"children\":[],\"createBy\":\"admin\",\"icon\":\"date\",\"isCache\":\"0\",\"isFrame\":\"1\",\"menuName\":\"提交列表\",\"menuType\":\"C\",\"orderNum\":0,\"params\":{},\"parentId\":2020,\"path\":\"homework_grading/list/:homeworkId\",\"status\":\"0\",\"visible\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-11-07 11:28:01', 72);
INSERT INTO `sys_oper_log` VALUES (236, '作业管理', 1, 'com.ruoyi.web.controller.proj_lwj.ClassHomeworkController.add()', 'POST', 1, 'admin', '研发部门', '/proj_lwj/homework', '127.0.0.1', '内网IP', '{\"attachments\":\"/profile/upload/2025/11/07/测试作业_20251107221820A001.docx\",\"content\":\"报告\",\"courseId\":1,\"createBy\":\"admin\",\"deadline\":\"2025-11-07 23:00:00\",\"homeworkId\":16,\"params\":{},\"sessionId\":4,\"title\":\"第9周作业\",\"totalScore\":100}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-11-07 22:18:22', 257);
INSERT INTO `sys_oper_log` VALUES (237, '菜单管理', 2, 'com.ruoyi.web.controller.system.SysMenuController.edit()', 'PUT', 1, 'admin', '研发部门', '/system/menu', '127.0.0.1', '内网IP', '{\"children\":[],\"createTime\":\"2025-11-07 10:34:17\",\"icon\":\"checkbox\",\"isCache\":\"0\",\"isFrame\":\"1\",\"menuId\":2021,\"menuName\":\"作业批改详情\",\"menuType\":\"C\",\"orderNum\":0,\"params\":{},\"parentId\":2020,\"path\":\"homework_grading/list/:homeworkId\",\"perms\":\"\",\"routeName\":\"\",\"status\":\"0\",\"updateBy\":\"admin\",\"visible\":\"1\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-11-07 22:24:16', 41);
INSERT INTO `sys_oper_log` VALUES (238, '菜单管理', 2, 'com.ruoyi.web.controller.system.SysMenuController.edit()', 'PUT', 1, 'admin', '研发部门', '/system/menu', '127.0.0.1', '内网IP', '{\"children\":[],\"createTime\":\"2025-11-07 11:28:01\",\"icon\":\"date\",\"isCache\":\"0\",\"isFrame\":\"1\",\"menuId\":2022,\"menuName\":\"提交列表\",\"menuType\":\"C\",\"orderNum\":0,\"params\":{},\"parentId\":2020,\"path\":\"homework_grading/list/:homeworkId\",\"perms\":\"\",\"routeName\":\"\",\"status\":\"0\",\"updateBy\":\"admin\",\"visible\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-11-07 22:24:37', 14);
INSERT INTO `sys_oper_log` VALUES (239, '菜单管理', 2, 'com.ruoyi.web.controller.system.SysMenuController.edit()', 'PUT', 1, 'admin', '研发部门', '/system/menu', '127.0.0.1', '内网IP', '{\"children\":[],\"createTime\":\"2025-11-07 10:34:17\",\"icon\":\"checkbox\",\"isCache\":\"0\",\"isFrame\":\"1\",\"menuId\":2021,\"menuName\":\"作业批改详情\",\"menuType\":\"C\",\"orderNum\":0,\"params\":{},\"parentId\":2020,\"path\":\"omework_grading/:homeworkId\",\"perms\":\"\",\"routeName\":\"\",\"status\":\"0\",\"updateBy\":\"admin\",\"visible\":\"1\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-11-07 22:24:57', 18);
INSERT INTO `sys_oper_log` VALUES (240, '菜单管理', 2, 'com.ruoyi.web.controller.system.SysMenuController.edit()', 'PUT', 1, 'admin', '研发部门', '/system/menu', '127.0.0.1', '内网IP', '{\"children\":[],\"createTime\":\"2025-11-02 15:16:04\",\"icon\":\"education\",\"isCache\":\"0\",\"isFrame\":\"1\",\"menuId\":2000,\"menuName\":\"作业管理\",\"menuType\":\"M\",\"orderNum\":0,\"params\":{},\"parentId\":0,\"path\":\"proj_lwj\",\"perms\":\"\",\"routeName\":\"\",\"status\":\"0\",\"updateBy\":\"admin\",\"visible\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-11-07 22:32:40', 13);
INSERT INTO `sys_oper_log` VALUES (241, '菜单管理', 2, 'com.ruoyi.web.controller.system.SysMenuController.edit()', 'PUT', 1, 'admin', '研发部门', '/system/menu', '127.0.0.1', '内网IP', '{\"children\":[],\"component\":\"proj_lwj/homework_publish/index\",\"createTime\":\"2025-11-02 15:17:17\",\"icon\":\"list\",\"isCache\":\"0\",\"isFrame\":\"1\",\"menuId\":2002,\"menuName\":\"作业发布\",\"menuType\":\"C\",\"orderNum\":1,\"params\":{},\"parentId\":2000,\"path\":\"homework_publish\",\"perms\":\"\",\"routeName\":\"\",\"status\":\"0\",\"updateBy\":\"admin\",\"visible\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-11-07 22:33:10', 13);
INSERT INTO `sys_oper_log` VALUES (242, '菜单管理', 2, 'com.ruoyi.web.controller.system.SysMenuController.edit()', 'PUT', 1, 'admin', '研发部门', '/system/menu', '127.0.0.1', '内网IP', '{\"children\":[],\"component\":\"proj_lwj/homework-upload/index\",\"createTime\":\"2025-11-02 15:18:15\",\"icon\":\"upload\",\"isCache\":\"0\",\"isFrame\":\"1\",\"menuId\":2003,\"menuName\":\"作业上传\",\"menuType\":\"C\",\"orderNum\":2,\"params\":{},\"parentId\":2000,\"path\":\"homework_upload\",\"perms\":\"\",\"routeName\":\"\",\"status\":\"0\",\"updateBy\":\"admin\",\"visible\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-11-07 22:33:57', 13);
INSERT INTO `sys_oper_log` VALUES (243, '菜单管理', 3, 'com.ruoyi.web.controller.system.SysMenuController.remove()', 'DELETE', 1, 'admin', '研发部门', '/system/menu/2021', '127.0.0.1', '内网IP', '2021', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-11-07 22:34:06', 17);
INSERT INTO `sys_oper_log` VALUES (244, '菜单管理', 3, 'com.ruoyi.web.controller.system.SysMenuController.remove()', 'DELETE', 1, 'admin', '研发部门', '/system/menu/2022', '127.0.0.1', '内网IP', '2022', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-11-07 22:34:09', 10);
INSERT INTO `sys_oper_log` VALUES (245, '菜单管理', 2, 'com.ruoyi.web.controller.system.SysMenuController.edit()', 'PUT', 1, 'admin', '研发部门', '/system/menu', '127.0.0.1', '内网IP', '{\"children\":[],\"component\":\"proj_lwj/homework_grading/index\",\"createTime\":\"2025-11-07 10:07:32\",\"icon\":\"edit\",\"isCache\":\"0\",\"isFrame\":\"1\",\"menuId\":2020,\"menuName\":\"作业批改\",\"menuType\":\"C\",\"orderNum\":3,\"params\":{},\"parentId\":2000,\"path\":\"homework_grading\",\"perms\":\"\",\"routeName\":\"\",\"status\":\"0\",\"updateBy\":\"admin\",\"visible\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-11-07 22:34:31', 13);
INSERT INTO `sys_oper_log` VALUES (246, '菜单管理', 1, 'com.ruoyi.web.controller.system.SysMenuController.add()', 'POST', 1, 'admin', '研发部门', '/system/menu', '127.0.0.1', '内网IP', '{\"children\":[],\"createBy\":\"admin\",\"icon\":\"list\",\"isCache\":\"0\",\"isFrame\":\"1\",\"menuName\":\"作业提交列表\",\"menuType\":\"C\",\"orderNum\":3,\"params\":{},\"parentId\":2000,\"path\":\"homework_grading/list/:homeworkId\",\"status\":\"0\",\"visible\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-11-07 23:23:43', 18);
INSERT INTO `sys_oper_log` VALUES (247, '菜单管理', 1, 'com.ruoyi.web.controller.system.SysMenuController.add()', 'POST', 1, 'admin', '研发部门', '/system/menu', '127.0.0.1', '内网IP', '{\"children\":[],\"createBy\":\"admin\",\"icon\":\"date\",\"isCache\":\"0\",\"isFrame\":\"1\",\"menuName\":\"作业批改详情\",\"menuType\":\"C\",\"orderNum\":4,\"params\":{},\"parentId\":2000,\"path\":\"homework_grading/:homeworkId\",\"status\":\"0\",\"visible\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-11-07 23:24:33', 15);
INSERT INTO `sys_oper_log` VALUES (248, '菜单管理', 2, 'com.ruoyi.web.controller.system.SysMenuController.edit()', 'PUT', 1, 'admin', '研发部门', '/system/menu', '127.0.0.1', '内网IP', '{\"children\":[],\"createTime\":\"2025-11-07 23:23:43\",\"icon\":\"list\",\"isCache\":\"0\",\"isFrame\":\"1\",\"menuId\":2023,\"menuName\":\"提交列表\",\"menuType\":\"C\",\"orderNum\":3,\"params\":{},\"parentId\":2000,\"path\":\"homework_grading/list/:homeworkId\",\"perms\":\"\",\"routeName\":\"\",\"status\":\"0\",\"updateBy\":\"admin\",\"visible\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-11-07 23:24:49', 12);
INSERT INTO `sys_oper_log` VALUES (249, '作业提交', 2, 'com.ruoyi.web.controller.proj_lwj.ClassHomeworkController.updateSubmit()', 'PUT', 1, 'admin', '研发部门', '/proj_lwj/homework/submit', '127.0.0.1', '内网IP', '{\"homeworkId\":10,\"params\":{},\"remark\":\"\",\"score\":90,\"status\":2,\"studentHomeworkId\":9,\"studentId\":38,\"submitTime\":\"2025-11-07 23:33:33\",\"updateBy\":\"admin\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-11-07 23:33:34', 44);
INSERT INTO `sys_oper_log` VALUES (250, '菜单管理', 3, 'com.ruoyi.web.controller.system.SysMenuController.remove()', 'DELETE', 1, 'admin', '研发部门', '/system/menu/2024', '127.0.0.1', '内网IP', '2024', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-11-07 23:33:57', 16);
INSERT INTO `sys_oper_log` VALUES (251, '菜单管理', 2, 'com.ruoyi.web.controller.system.SysMenuController.edit()', 'PUT', 1, 'admin', '研发部门', '/system/menu', '127.0.0.1', '内网IP', '{\"children\":[],\"createTime\":\"2025-11-07 23:23:43\",\"icon\":\"list\",\"isCache\":\"0\",\"isFrame\":\"1\",\"menuId\":2023,\"menuName\":\"提交列表\",\"menuType\":\"C\",\"orderNum\":3,\"params\":{},\"parentId\":2000,\"path\":\"homework_grading/list/:homeworkId\",\"perms\":\"\",\"routeName\":\"\",\"status\":\"0\",\"updateBy\":\"admin\",\"visible\":\"1\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-11-07 23:34:03', 15);
INSERT INTO `sys_oper_log` VALUES (252, '菜单管理', 2, 'com.ruoyi.web.controller.system.SysMenuController.edit()', 'PUT', 1, 'admin', '研发部门', '/system/menu', '127.0.0.1', '内网IP', '{\"children\":[],\"component\":\"\",\"createTime\":\"2025-11-07 10:07:32\",\"icon\":\"edit\",\"isCache\":\"0\",\"isFrame\":\"1\",\"menuId\":2020,\"menuName\":\"作业批改\",\"menuType\":\"C\",\"orderNum\":3,\"params\":{},\"parentId\":2000,\"path\":\"homework_grading\",\"perms\":\"\",\"routeName\":\"\",\"status\":\"0\",\"updateBy\":\"admin\",\"visible\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-11-07 23:34:10', 14);
INSERT INTO `sys_oper_log` VALUES (253, '菜单管理', 2, 'com.ruoyi.web.controller.system.SysMenuController.edit()', 'PUT', 1, 'admin', '研发部门', '/system/menu', '127.0.0.1', '内网IP', '{\"children\":[],\"component\":\"\",\"createTime\":\"2025-11-02 15:18:15\",\"icon\":\"upload\",\"isCache\":\"0\",\"isFrame\":\"1\",\"menuId\":2003,\"menuName\":\"作业上传\",\"menuType\":\"C\",\"orderNum\":2,\"params\":{},\"parentId\":2000,\"path\":\"homework_upload\",\"perms\":\"\",\"routeName\":\"\",\"status\":\"0\",\"updateBy\":\"admin\",\"visible\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-11-07 23:34:16', 15);
INSERT INTO `sys_oper_log` VALUES (254, '菜单管理', 2, 'com.ruoyi.web.controller.system.SysMenuController.edit()', 'PUT', 1, 'admin', '研发部门', '/system/menu', '127.0.0.1', '内网IP', '{\"children\":[],\"component\":\"\",\"createTime\":\"2025-11-02 15:17:17\",\"icon\":\"list\",\"isCache\":\"0\",\"isFrame\":\"1\",\"menuId\":2002,\"menuName\":\"作业发布\",\"menuType\":\"C\",\"orderNum\":1,\"params\":{},\"parentId\":2000,\"path\":\"homework_publish\",\"perms\":\"\",\"routeName\":\"\",\"status\":\"0\",\"updateBy\":\"admin\",\"visible\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-11-07 23:34:22', 11);
INSERT INTO `sys_oper_log` VALUES (255, '作业提交', 2, 'com.ruoyi.web.controller.proj_lwj.ClassHomeworkController.updateSubmit()', 'PUT', 1, 'admin', '研发部门', '/proj_lwj/homework/submit', '127.0.0.1', '内网IP', '{\"homeworkId\":11,\"params\":{},\"remark\":\"\",\"score\":90,\"status\":2,\"studentHomeworkId\":10,\"studentId\":38,\"submitTime\":\"2025-11-08 00:13:02\",\"updateBy\":\"admin\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-11-08 00:13:02', 40);
INSERT INTO `sys_oper_log` VALUES (256, '作业提交', 1, 'com.ruoyi.web.controller.proj_lwj.ClassHomeworkController.submit()', 'POST', 1, 'admin', '研发部门', '/proj_lwj/homework/submit', '127.0.0.1', '内网IP', '{\"createBy\":\"admin\",\"homeworkId\":9,\"params\":{},\"remark\":\"\",\"status\":1,\"studentHomeworkId\":11,\"studentId\":38,\"studentName\":\"黎文靖\",\"studentNo\":\"2023141460368\",\"submissionFiles\":\"测试作业.docx\",\"submitTime\":\"2025-11-08 00:26:14\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-11-08 00:26:14', 41);
INSERT INTO `sys_oper_log` VALUES (257, '作业提交', 2, 'com.ruoyi.web.controller.proj_lwj.ClassHomeworkController.updateSubmit()', 'PUT', 1, 'admin', '研发部门', '/proj_lwj/homework/submit', '127.0.0.1', '内网IP', '{\"homeworkId\":9,\"params\":{},\"remark\":\"完成基本功能\",\"score\":90,\"status\":2,\"studentHomeworkId\":11,\"studentId\":38,\"submitTime\":\"2025-11-08 00:27:00\",\"updateBy\":\"admin\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-11-08 00:27:00', 15);
INSERT INTO `sys_oper_log` VALUES (258, '保存抽取记录', 1, 'com.ruoyi.web.controller.proj_myx.RandomPickController.savePick()', 'POST', 1, 'admin', '研发部门', '/proj_myx/random/pick/save', '127.0.0.1', '内网IP', '{\"pickTime\":\"2025-11-08 00:30:24.073\",\"sessionId\":1,\"studentId\":32,\"teacherId\":0}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-11-08 00:30:24', 27);
INSERT INTO `sys_oper_log` VALUES (259, '作业管理', 3, 'com.ruoyi.web.controller.proj_lwj.ClassHomeworkController.remove()', 'DELETE', 1, 'admin', '研发部门', '/proj_lwj/homework/11', '127.0.0.1', '内网IP', '[11]', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-11-08 00:33:17', 28);
INSERT INTO `sys_oper_log` VALUES (260, '作业管理', 1, 'com.ruoyi.web.controller.proj_lwj.ClassHomeworkController.add()', 'POST', 1, 'admin', '研发部门', '/proj_lwj/homework', '127.0.0.1', '内网IP', '{\"attachments\":\"\",\"content\":\"11\",\"courseId\":1,\"createBy\":\"admin\",\"deadline\":\"2025-11-09 00:00:00\",\"homeworkId\":17,\"params\":{},\"sessionId\":1,\"title\":\"11\",\"totalScore\":100}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-11-08 00:45:23', 19);
INSERT INTO `sys_oper_log` VALUES (261, '作业提交', 1, 'com.ruoyi.web.controller.proj_lwj.ClassHomeworkController.submit()', 'POST', 1, 'admin', '研发部门', '/proj_lwj/homework/submit', '127.0.0.1', '内网IP', '{\"createBy\":\"admin\",\"homeworkId\":17,\"params\":{},\"remark\":\"\",\"status\":1,\"studentHomeworkId\":12,\"studentId\":38,\"studentName\":\"黎文靖\",\"studentNo\":\"2023141460368\",\"submissionFiles\":\"测试作业.docx\",\"submitTime\":\"2025-11-08 00:45:52\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-11-08 00:45:52', 30);
INSERT INTO `sys_oper_log` VALUES (262, '作业管理', 3, 'com.ruoyi.web.controller.proj_lwj.ClassHomeworkController.remove()', 'DELETE', 1, 'admin', '研发部门', '/proj_lwj/homework/17', '127.0.0.1', '内网IP', '[17]', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-11-08 00:46:00', 9);
INSERT INTO `sys_oper_log` VALUES (263, '作业管理', 3, 'com.ruoyi.web.controller.proj_lwj.ClassHomeworkController.remove()', 'DELETE', 1, 'admin', '研发部门', '/proj_lwj/homework/10', '127.0.0.1', '内网IP', '{\"cascade\":\"true\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-11-08 00:56:34', 21);
INSERT INTO `sys_oper_log` VALUES (264, '作业管理', 1, 'com.ruoyi.web.controller.proj_lwj.ClassHomeworkController.add()', 'POST', 1, 'admin', '研发部门', '/proj_lwj/homework', '127.0.0.1', '内网IP', '{\"attachments\":\"\",\"content\":\"9\",\"courseId\":1,\"createBy\":\"admin\",\"deadline\":\"2025-11-08 00:00:00\",\"homeworkId\":18,\"params\":{},\"sessionId\":1,\"title\":\"9\",\"totalScore\":100}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-11-08 01:14:28', 232);
INSERT INTO `sys_oper_log` VALUES (265, '作业提交', 2, 'com.ruoyi.web.controller.proj_lwj.ClassHomeworkController.updateSubmit()', 'PUT', 1, 'admin', '研发部门', '/proj_lwj/homework/submit', '127.0.0.1', '内网IP', '{\"homeworkId\":17,\"params\":{},\"remark\":\"\",\"studentHomeworkId\":12,\"studentId\":38,\"studentName\":\"黎文靖\",\"studentNo\":\"2023141460368\",\"submissionFiles\":\"测试作业.docx\",\"submitTime\":\"2025-11-08 01:15:01\",\"updateBy\":\"admin\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-11-08 01:15:01', 40);
INSERT INTO `sys_oper_log` VALUES (266, '作业提交', 1, 'com.ruoyi.web.controller.proj_lwj.ClassHomeworkController.submit()', 'POST', 1, 'admin', '研发部门', '/proj_lwj/homework/submit', '127.0.0.1', '内网IP', '{\"createBy\":\"admin\",\"homeworkId\":18,\"params\":{},\"remark\":\"\",\"status\":1,\"studentHomeworkId\":13,\"studentId\":38,\"studentName\":\"黎文靖\",\"studentNo\":\"2023141460368\",\"submissionFiles\":\"测试作业.docx\",\"submitTime\":\"2025-11-08 01:15:27\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-11-08 01:15:27', 27);
INSERT INTO `sys_oper_log` VALUES (267, '作业管理', 3, 'com.ruoyi.web.controller.proj_lwj.ClassHomeworkController.remove()', 'DELETE', 1, 'admin', '研发部门', '/proj_lwj/homework/18', '127.0.0.1', '内网IP', '{\"cascade\":\"true\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-11-08 01:16:09', 20);
INSERT INTO `sys_oper_log` VALUES (268, '作业提交', 2, 'com.ruoyi.web.controller.proj_lwj.ClassHomeworkController.updateSubmit()', 'PUT', 1, 'admin', '研发部门', '/proj_lwj/homework/submit', '127.0.0.1', '内网IP', '{\"homeworkId\":17,\"params\":{},\"studentHomeworkId\":12,\"studentId\":38,\"studentName\":\"黎文靖\",\"studentNo\":\"2023141460368\",\"submissionFiles\":\"测试作业.docx\"}', '{\"msg\":\"该作业已被删除，无法修改提交记录\",\"code\":500}', 0, NULL, '2025-11-08 01:31:45', 24);
INSERT INTO `sys_oper_log` VALUES (269, '作业提交', 2, 'com.ruoyi.web.controller.proj_lwj.ClassHomeworkController.updateSubmit()', 'PUT', 1, 'admin', '研发部门', '/proj_lwj/homework/submit', '127.0.0.1', '内网IP', '{\"homeworkId\":17,\"params\":{},\"studentHomeworkId\":12,\"studentId\":38,\"studentName\":\"黎文靖\",\"studentNo\":\"2023141460368\",\"submissionFiles\":\"测试作业.docx\"}', '{\"msg\":\"该作业已被删除，无法修改提交记录\",\"code\":500}', 0, NULL, '2025-11-08 01:31:48', 14);
INSERT INTO `sys_oper_log` VALUES (270, '作业管理', 1, 'com.ruoyi.web.controller.proj_lwj.ClassHomeworkController.add()', 'POST', 1, 'admin', '研发部门', '/proj_lwj/homework', '127.0.0.1', '内网IP', '{\"attachments\":\"\",\"content\":\"111\",\"courseId\":1,\"createBy\":\"admin\",\"params\":{},\"sessionId\":1,\"title\":\"111\",\"totalScore\":100}', '{\"msg\":\"发布作业失败：\\r\\n### Error updating database.  Cause: java.sql.SQLIntegrityConstraintViolationException: Column \'deadline\' cannot be null\\r\\n### The error may exist in com/ruoyi/proj_lwj/mapper/ClassHomeworkMapper.java (best guess)\\r\\n### The error may involve com.ruoyi.proj_lwj.mapper.ClassHomeworkMapper.insertHomework-Inline\\r\\n### The error occurred while setting parameters\\r\\n### SQL: INSERT INTO class_homework (course_id, session_id, title, content, total_score, deadline, attachments, create_by, create_time) VALUES (?, ?, ?, ?, ?, ?, ?, ?, NOW())\\r\\n### Cause: java.sql.SQLIntegrityConstraintViolationException: Column \'deadline\' cannot be null\\n; Column \'deadline\' cannot be null; nested exception is java.sql.SQLIntegrityConstraintViolationException: Column \'deadline\' cannot be null\",\"code\":500}', 0, NULL, '2025-11-08 01:42:58', 188);
INSERT INTO `sys_oper_log` VALUES (271, '作业管理', 1, 'com.ruoyi.web.controller.proj_lwj.ClassHomeworkController.add()', 'POST', 1, 'admin', '研发部门', '/proj_lwj/homework', '127.0.0.1', '内网IP', '{\"attachments\":\"\",\"content\":\"111\",\"courseId\":1,\"createBy\":\"admin\",\"deadline\":\"2025-11-09 00:00:00\",\"homeworkId\":19,\"params\":{},\"sessionId\":1,\"title\":\"111\",\"totalScore\":100}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-11-08 01:43:10', 12);
INSERT INTO `sys_oper_log` VALUES (272, '作业提交', 1, 'com.ruoyi.web.controller.proj_lwj.ClassHomeworkController.submit()', 'POST', 1, 'admin', '研发部门', '/proj_lwj/homework/submit', '127.0.0.1', '内网IP', '{\"createBy\":\"admin\",\"homeworkId\":19,\"params\":{},\"remark\":\"\",\"status\":1,\"studentHomeworkId\":14,\"studentId\":38,\"studentName\":\"黎文靖\",\"studentNo\":\"2023141460368\",\"submissionFiles\":\"测试作业.docx\",\"submitTime\":\"2025-11-08 01:53:46\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-11-08 01:53:47', 268);
INSERT INTO `sys_oper_log` VALUES (273, '作业提交', 2, 'com.ruoyi.web.controller.proj_lwj.ClassHomeworkController.updateSubmit()', 'PUT', 1, 'admin', '研发部门', '/proj_lwj/homework/submit', '127.0.0.1', '内网IP', '{\"homeworkId\":19,\"params\":{},\"remark\":\"\",\"score\":90,\"status\":2,\"studentHomeworkId\":14,\"studentId\":38,\"submitTime\":\"2025-11-08 01:55:24\",\"updateBy\":\"admin\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-11-08 01:55:24', 28);
INSERT INTO `sys_oper_log` VALUES (274, '菜单管理', 2, 'com.ruoyi.web.controller.system.SysMenuController.edit()', 'PUT', 1, 'admin', '研发部门', '/system/menu', '127.0.0.1', '内网IP', '{\"children\":[],\"component\":\"\",\"createTime\":\"2025-11-02 15:17:17\",\"icon\":\"row\",\"isCache\":\"0\",\"isFrame\":\"1\",\"menuId\":2002,\"menuName\":\"作业发布\",\"menuType\":\"C\",\"orderNum\":1,\"params\":{},\"parentId\":2000,\"path\":\"homework_publish\",\"perms\":\"\",\"routeName\":\"\",\"status\":\"0\",\"updateBy\":\"admin\",\"visible\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-11-09 01:26:30', 80);
INSERT INTO `sys_oper_log` VALUES (275, '菜单管理', 2, 'com.ruoyi.web.controller.system.SysMenuController.edit()', 'PUT', 1, 'admin', '研发部门', '/system/menu', '127.0.0.1', '内网IP', '{\"children\":[],\"component\":\"\",\"createTime\":\"2025-11-02 15:17:17\",\"icon\":\"list\",\"isCache\":\"0\",\"isFrame\":\"1\",\"menuId\":2002,\"menuName\":\"作业发布\",\"menuType\":\"C\",\"orderNum\":1,\"params\":{},\"parentId\":2000,\"path\":\"homework_publish\",\"perms\":\"\",\"routeName\":\"\",\"status\":\"0\",\"updateBy\":\"admin\",\"visible\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-11-09 01:26:59', 29);
INSERT INTO `sys_oper_log` VALUES (276, '作业管理', 1, 'com.ruoyi.web.controller.proj_lwj.ClassHomeworkController.add()', 'POST', 1, 'admin', '研发部门', '/proj_lwj/homework', '127.0.0.1', '内网IP', '{\"attachments\":\"\",\"content\":\"222\",\"courseId\":1,\"createBy\":\"admin\",\"deadline\":\"2025-11-10 00:00:00\",\"homeworkId\":20,\"params\":{},\"sessionId\":1,\"title\":\"第九周作业\",\"totalScore\":100}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-11-09 12:41:20', 37);
INSERT INTO `sys_oper_log` VALUES (277, '作业提交', 2, 'com.ruoyi.web.controller.proj_lwj.ClassHomeworkController.updateSubmit()', 'PUT', 1, 'admin', '研发部门', '/proj_lwj/homework/submit', '127.0.0.1', '内网IP', '{\"homeworkId\":17,\"params\":{},\"remark\":\"\",\"studentHomeworkId\":12,\"studentId\":38,\"studentName\":\"黎文靖\",\"studentNo\":\"2023141460368\",\"submissionFiles\":\"测试作业.docx\"}', '{\"msg\":\"该作业已被删除，无法修改提交记录\",\"code\":500}', 0, NULL, '2025-11-09 12:42:07', 42);
INSERT INTO `sys_oper_log` VALUES (278, '作业提交', 2, 'com.ruoyi.web.controller.proj_lwj.ClassHomeworkController.updateSubmit()', 'PUT', 1, 'admin', '研发部门', '/proj_lwj/homework/submit', '127.0.0.1', '内网IP', '{\"homeworkId\":17,\"params\":{},\"remark\":\"\",\"studentHomeworkId\":12,\"studentId\":38,\"studentName\":\"黎文靖\",\"studentNo\":\"2023141460368\",\"submissionFiles\":\"测试作业.docx\"}', '{\"msg\":\"该作业已被删除，无法修改提交记录\",\"code\":500}', 0, NULL, '2025-11-09 12:42:18', 15);
INSERT INTO `sys_oper_log` VALUES (279, '作业提交', 1, 'com.ruoyi.web.controller.proj_lwj.ClassHomeworkController.submit()', 'POST', 1, 'admin', '研发部门', '/proj_lwj/homework/submit', '127.0.0.1', '内网IP', '{\"createBy\":\"admin\",\"homeworkId\":20,\"params\":{},\"remark\":\"\",\"status\":1,\"studentId\":38,\"studentName\":\"黎文靖\",\"studentNo\":\"2023141460368\",\"submissionFiles\":\"测试作业.docx\",\"submitTime\":\"2025-11-09 12:42:52\"}', NULL, 1, '\r\n### Error updating database.  Cause: java.sql.SQLSyntaxErrorException: Unknown column \'student_no\' in \'field list\'\r\n### The error may exist in com/ruoyi/proj_lwj/mapper/ClassStudentHomeworkMapper.java (best guess)\r\n### The error may involve com.ruoyi.proj_lwj.mapper.ClassStudentHomeworkMapper.insert-Inline\r\n### The error occurred while setting parameters\r\n### SQL: INSERT INTO class_student_homework (homework_id, student_id, student_no, student_name, submission_files, submit_time, status, create_by, create_time) VALUES (?, ?, ?, ?, ?, ?, ?, ?, NOW())\r\n### Cause: java.sql.SQLSyntaxErrorException: Unknown column \'student_no\' in \'field list\'\n; bad SQL grammar []; nested exception is java.sql.SQLSyntaxErrorException: Unknown column \'student_no\' in \'field list\'', '2025-11-09 12:42:52', 155);
INSERT INTO `sys_oper_log` VALUES (280, '作业提交', 1, 'com.ruoyi.web.controller.proj_lwj.ClassHomeworkController.submit()', 'POST', 1, 'admin', '研发部门', '/proj_lwj/homework/submit', '127.0.0.1', '内网IP', '{\"createBy\":\"admin\",\"homeworkId\":20,\"params\":{},\"remark\":\"\",\"status\":1,\"studentId\":38,\"studentName\":\"黎文靖\",\"studentNo\":\"2023141460368\",\"submissionFiles\":\"测试作业.docx\",\"submitTime\":\"2025-11-09 16:24:25\"}', NULL, 1, '\r\n### Error updating database.  Cause: java.sql.SQLSyntaxErrorException: Unknown column \'student_no\' in \'field list\'\r\n### The error may exist in com/ruoyi/proj_lwj/mapper/ClassStudentHomeworkMapper.java (best guess)\r\n### The error may involve com.ruoyi.proj_lwj.mapper.ClassStudentHomeworkMapper.insert-Inline\r\n### The error occurred while setting parameters\r\n### SQL: INSERT INTO class_student_homework (homework_id, student_id, student_no, student_name, submission_files, submit_time, status, create_by, create_time) VALUES (?, ?, ?, ?, ?, ?, ?, ?, NOW())\r\n### Cause: java.sql.SQLSyntaxErrorException: Unknown column \'student_no\' in \'field list\'\n; bad SQL grammar []; nested exception is java.sql.SQLSyntaxErrorException: Unknown column \'student_no\' in \'field list\'', '2025-11-09 16:24:25', 160);
INSERT INTO `sys_oper_log` VALUES (281, '作业提交', 1, 'com.ruoyi.web.controller.proj_lwj.ClassHomeworkController.submit()', 'POST', 1, 'admin', '研发部门', '/proj_lwj/homework/submit', '127.0.0.1', '内网IP', '{\"createBy\":\"admin\",\"homeworkId\":20,\"params\":{},\"remark\":\"\",\"status\":1,\"studentHomeworkId\":15,\"studentId\":38,\"studentName\":\"黎文靖\",\"studentNo\":\"2023141460368\",\"submissionFiles\":\"测试作业.docx\",\"submitTime\":\"2025-11-09 16:28:57\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-11-09 16:28:57', 36);
INSERT INTO `sys_oper_log` VALUES (282, '作业管理', 1, 'com.ruoyi.web.controller.proj_lwj.ClassHomeworkController.add()', 'POST', 1, 'admin', '研发部门', '/proj_lwj/homework', '127.0.0.1', '内网IP', '{\"attachments\":\"\",\"content\":\"11\",\"courseId\":1,\"createBy\":\"admin\",\"deadline\":\"2025-11-10 00:00:00\",\"homeworkId\":21,\"params\":{},\"sessionId\":1,\"title\":\"111\",\"totalScore\":100}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-11-09 18:26:02', 306);
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (1, 103, 'admin', '若依', '00', 'ry@163.com', '15888888888', '1', '', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '0', '127.0.0.1', '2025-11-09 18:58:54', '2025-10-30 17:06:55', 'admin', '2025-10-30 17:06:55', '', NULL, '管理员');
