...
-- ----------------------------
INSERT INTO `class_article` VALUES (1, 'Spring Boot 入门教程', '本文介绍Spring Boot的基本使用和配置', '<h1><img src=\"/dev-api/profile/upload/2025/11/02/屏幕截图 2024-06-06 011230_20251102021029A001.png\">入门</h1>', 'https://picsum.photos/id/1029/600/400', '技术', 'published', 167, 12, 59, 12, 0, '岂皓月', 1, 'admin', '2025-11-01 23:24:22', '', '2025-11-04 22:58:33', NULL);
...
) ENGINE = InnoDB AUTO_INCREMENT = 16 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '作业主表' ROW_FORMAT = DYNAMIC;
...
-- ----------------------------
INSERT INTO `class_session` VALUES (1, '研究与开发实践', 1, 1, 50, 'A', 1, '', NULL, '', NULL, 1, '1', 45, '20:50', '20:50');
...
INSERT INTO `class_session` VALUES (7, '研究与开发实践', 1, 0, 32, 'C', 1, 'admin', '2025-11-01 00:42:58', 'admin', '2025-11-04 20:42:55', 1, '1', 45, '12:00', '22:00');
...
INSERT INTO `class_session` VALUES (19, '数据库', 2, 1, 30, 'fgd', NULL, 'admin', '2025-11-08 22:19:13', '', NULL, 5, '2', 45, '10:15', '11:20');
...
) ENGINE = InnoDB AUTO_INCREMENT = 122 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '系统访问记录' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `sys_logininfor` VALUES (119, 'admin', '127.0.0.1', '内网IP', 'Chrome 14', 'Windows 10', '0', '登录成功', '2025-11-06 18:09:45');
INSERT INTO `sys_logininfor` VALUES (120, 'admin', '127.0.0.1', '内网IP', 'Chrome 14', 'Windows 10', '0', '登录成功', '2025-11-06 21:36:47');
INSERT INTO `sys_logininfor` VALUES (121, 'admin', '127.0.0.1', '内网IP', 'Chrome 14', 'Windows 10', '0', '登录成功', '2025-11-08 22:17:08');
...
) ENGINE = InnoDB AUTO_INCREMENT = 243 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '操作日志记录' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `sys_oper_log` VALUES (227, '课堂管理', 1, 'com.ruoyi.web.controller.proj_lw.ClassSessionController.add()', 'POST', 1, 'admin', '研发部门', '/proj_lw/session', '127.0.0.1', '内网IP', '{\"classDuration\":45,\"className\":\"研究与开发实践 - 课堂\",\"courseId\":1,\"createBy\":\"admin\",\"endTime\":\"10:05\",\"params\":{},\"sessionId\":12,\"startTime\":\"08:00\",\"status\":1,\"teacher\":\"D\",\"teacherId\":3,\"totalStudents\":30,\"weekDay\":\"5\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-11-06 22:15:09', 17);
INSERT INTO `sys_oper_log` VALUES (228, '课堂管理', 3, 'com.ruoyi.web.controller.proj_lw.ClassSessionController.remove()', 'DELETE', 1, 'admin', '研发部门', '/proj_lw/session/12', '127.0.0.1', '内网IP', '[12]', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-11-06 22:26:54', 20);
INSERT INTO `sys_oper_log` VALUES (229, '课堂管理', 1, 'com.ruoyi.web.controller.proj_lw.ClassSessionController.add()', 'POST', 1, 'admin', '研发部门', '/proj_lw/session', '127.0.0.1', '内网IP', '{\"classDuration\":45,\"courseId\":1,\"createBy\":\"admin\",\"endTime\":\"22:30\",\"params\":{},\"startTime\":\"22:27\",\"status\":1,\"teacher\":\"D\",\"teacherId\":3,\"totalStudents\":30,\"weekDay\":\"1\"}', NULL, 1, '\r\n### Error updating database.  Cause: java.sql.SQLIntegrityConstraintViolationException: Column \'class_name\' cannot be null\r\n### The error may exist in com/ruoyi/proj_lw/mapper/ClassSessionMapper.java (best guess)\r\n### The error may involve com.ruoyi.proj_lw.mapper.ClassSessionMapper.insertSession-Inline\r\n### The error occurred while setting parameters\r\n### SQL: INSERT INTO class_session (class_name, teacher_id, start_time, end_time, week_day, class_duration, status, total_students, teacher, course_id, class_number, create_by, create_time) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, NOW())\r\n### Cause: java.sql.SQLIntegrityConstraintViolationException: Column \'class_name\' cannot be null\n; Column \'class_name\' cannot be null; nested exception is java.sql.SQLIntegrityConstraintViolationException: Column \'class_name\' cannot be null', '2025-11-06 22:27:11', 40);
INSERT INTO `sys_oper_log` VALUES (230, '课堂管理', 1, 'com.ruoyi.web.controller.proj_lw.ClassSessionController.add()', 'POST', 1, 'admin', '研发部门', '/proj_lw/session', '127.0.0.1', '内网IP', '{\"classDuration\":45,\"courseId\":1,\"createBy\":\"admin\",\"endTime\":\"11:27\",\"params\":{},\"startTime\":\"09:27\",\"status\":0,\"teacher\":\"1E2E\",\"teacherId\":3,\"totalStudents\":30,\"weekDay\":\"1\"}', NULL, 1, '\r\n### Error updating database.  Cause: java.sql.SQLIntegrityConstraintViolationException: Column \'class_name\' cannot be null\r\n### The error may exist in com/ruoyi/proj_lw/mapper/ClassSessionMapper.java (best guess)\r\n### The error may involve com.ruoyi.proj_lw.mapper.ClassSessionMapper.insertSession-Inline\r\n### The error occurred while setting parameters\r\n### SQL: INSERT INTO class_session (class_name, teacher_id, start_time, end_time, week_day, class_duration, status, total_students, teacher, course_id, class_number, create_by, create_time) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, NOW())\r\n### Cause: java.sql.SQLIntegrityConstraintViolationException: Column \'class_name\' cannot be null\n; Column \'class_name\' cannot be null; nested exception is java.sql.SQLIntegrityConstraintViolationException: Column \'class_name\' cannot be null', '2025-11-06 22:27:58', 3);
INSERT INTO `sys_oper_log` VALUES (231, '课堂管理', 1, 'com.ruoyi.web.controller.proj_lw.ClassSessionController.add()', 'POST', 1, 'admin', '研发部门', '/proj_lw/session', '127.0.0.1', '内网IP', '{\"classDuration\":45,\"courseId\":1,\"createBy\":\"admin\",\"endTime\":\"22:29\",\"params\":{},\"sessionId\":13,\"startTime\":\"21:29\",\"status\":1,\"teacher\":\"ADCS\",\"teacherId\":4,\"totalStudents\":30,\"weekDay\":\"4\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-11-06 22:30:05', 8);
INSERT INTO `sys_oper_log` VALUES (232, '课堂管理', 3, 'com.ruoyi.web.controller.proj_lw.ClassSessionController.remove()', 'DELETE', 1, 'admin', '研发部门', '/proj_lw/session/13', '127.0.0.1', '内网IP', '[13]', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-11-06 22:33:06', 19);
INSERT INTO `sys_oper_log` VALUES (233, '课堂管理', 1, 'com.ruoyi.web.controller.proj_lw.ClassSessionController.add()', 'POST', 1, 'admin', '研发部门', '/proj_lw/session', '127.0.0.1', '内网IP', '{\"classDuration\":45,\"className\":\"研究与开发实践-临时6414\",\"courseId\":1,\"createBy\":\"admin\",\"endTime\":\"22:34\",\"params\":{},\"sessionId\":14,\"startTime\":\"22:33\",\"status\":1,\"teacher\":\"zcs\",\"teacherId\":2,\"totalStudents\":30,\"weekDay\":\"2\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-11-06 22:33:26', 17);
INSERT INTO `sys_oper_log` VALUES (234, '课堂管理', 3, 'com.ruoyi.web.controller.proj_lw.ClassSessionController.remove()', 'DELETE', 1, 'admin', '研发部门', '/proj_lw/session/14', '127.0.0.1', '内网IP', '[14]', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-11-06 22:34:57', 8);
INSERT INTO `sys_oper_log` VALUES (235, '课堂管理', 1, 'com.ruoyi.web.controller.proj_lw.ClassSessionController.add()', 'POST', 1, 'admin', '研发部门', '/proj_lw/session', '127.0.0.1', '内网IP', '{\"classDuration\":45,\"courseId\":1,\"createBy\":\"admin\",\"endTime\":\"22:36\",\"params\":{},\"sessionId\":15,\"startTime\":\"22:35\",\"status\":1,\"teacher\":\"sdsdf\",\"teacherId\":1,\"totalStudents\":30,\"weekDay\":\"3\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-11-06 22:35:16', 8);
INSERT INTO `sys_oper_log` VALUES (236, '课堂管理', 3, 'com.ruoyi.web.controller.proj_lw.ClassSessionController.remove()', 'DELETE', 1, 'admin', '研发部门', '/proj_lw/session/15', '127.0.0.1', '内网IP', '[15]', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-11-06 22:39:17', 9);
INSERT INTO `sys_oper_log` VALUES (237, '课堂管理', 1, 'com.ruoyi.web.controller.proj_lw.ClassSessionController.add()', 'POST', 1, 'admin', '研发部门', '/proj_lw/session', '127.0.0.1', '内网IP', '{\"classDuration\":45,\"className\":\"研究与开发实践\",\"courseId\":1,\"createBy\":\"admin\",\"endTime\":\"22:41\",\"params\":{},\"sessionId\":16,\"startTime\":\"22:39\",\"status\":1,\"teacher\":\"阿斯顿\",\"teacherId\":1,\"totalStudents\":30,\"weekDay\":\"3\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-11-06 22:40:02', 17);
INSERT INTO `sys_oper_log` VALUES (238, '课堂管理', 3, 'com.ruoyi.web.controller.proj_lw.ClassSessionController.remove()', 'DELETE', 1, 'admin', '研发部门', '/proj_lw/session/16', '127.0.0.1', '内网IP', '[16]', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-11-06 22:40:08', 9);
INSERT INTO `sys_oper_log` VALUES (239, '课堂管理', 1, 'com.ruoyi.web.controller.proj_lw.ClassSessionController.add()', 'POST', 1, 'admin', '研发部门', '/proj_lw/session', '127.0.0.1', '内网IP', '{\"classDuration\":45,\"className\":\"研究与开发实践\",\"courseId\":1,\"createBy\":\"admin\",\"endTime\":\"22:49\",\"params\":{},\"sessionId\":17,\"startTime\":\"22:47\",\"status\":0,\"teacher\":\"V\",\"teacherId\":1,\"totalStudents\":30,\"weekDay\":\"2\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-11-06 22:47:40', 15);
INSERT INTO `sys_oper_log` VALUES (240, '课堂管理', 3, 'com.ruoyi.web.controller.proj_lw.ClassSessionController.remove()', 'DELETE', 1, 'admin', '研发部门', '/proj_lw/session/17', '127.0.0.1', '内网IP', '[17]', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-11-06 22:47:45', 13);
INSERT INTO `sys_oper_log` VALUES (241, '课堂管理', 1, 'com.ruoyi.web.controller.proj_lw.ClassSessionController.add()', 'POST', 1, 'admin', '研发部门', '/proj_lw/session', '127.0.0.1', '内网IP', '{\"classDuration\":45,\"className\":\"研究与开发实践\",\"courseId\":1,\"createBy\":\"admin\",\"endTime\":\"23:27\",\"params\":{},\"sessionId\":18,\"startTime\":\"23:25\",\"status\":1,\"teacher\":\"BV\",\"teacherId\":2,\"totalStudents\":30,\"weekDay\":\"4\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-11-06 23:25:53', 23);
INSERT INTO `sys_oper_log` VALUES (242, '课堂管理', 1, 'com.ruoyi.web.controller.proj_lw.ClassSessionController.add()', 'POST', 1, 'admin', '研发部门', '/proj_lw/session', '127.0.0.1', '内网IP', '{\"classDuration\":45,\"className\":\"数据库\",\"courseId\":5,\"createBy\":\"admin\",\"endTime\":\"11:20\",\"params\":{},\"sessionId\":19,\"startTime\":\"10:15\",\"status\":1,\"teacher\":\"fgd\",\"teacherId\":2,\"totalStudents\":30,\"weekDay\":\"2\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-11-08 22:19:13', 26);
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (1, 103, 'admin', '若依', '00', 'ry@163.com', '15888888888', '1', '', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '0', '127.0.0.1', '2025-11-08 22:17:08', '2025-10-30 17:06:55', 'admin', '2025-10-30 17:06:55', '', NULL, '管理员');
