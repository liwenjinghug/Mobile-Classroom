...
public interface ForumPostMapper {
     ...
     */
    @Select("""
        SELECT p.*, u.nick_name AS nickName, u.avatar
     ...
     */
    @Insert("""
        INSERT INTO class_forum_post (user_id, content, image_urls, like_count, comment_count, status, del_flag, create_by, create_time)
