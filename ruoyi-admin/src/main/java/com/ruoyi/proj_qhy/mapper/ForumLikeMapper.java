...
public interface ForumLikeMapper {
     ...
     */
    @Select("""
        SELECT l.*, u.nick_name AS nickName
     ...
     */
    @Insert("""
        INSERT INTO class_forum_like (post_id, user_id, del_flag, create_by, create_time)
     ...
     */
    @Update("""
        UPDATE class_forum_like SET del_flag = '2', update_by = #{updateBy}, update_time = NOW()
     ...
     */
    @Select("""
        SELECT l.like_id AS noticeId, l.post_id, u.user_id AS operatorUserId, u.nick_name AS operatorNickName,
